...
class SeasonDetailTvSeriesPage extends StatefulWidget {
  static const routeName = '/detail-season';
  final int id;
  final int seasonNumber;

  const SeasonDetailTvSeriesPage({
    required this.id,
  ...
  @override
  State<SeasonDetailTvSeriesPage> createState() =>
      _SeasonDetailTvSeriesPageState();
}

class _SeasonDetailTvSeriesPageState extends State<SeasonDetailTvSeriesPage> {
  @override
  void initState() {
    super.initState();
    Future.microtask(
      () => context
          .read<SeasonDetailTvSeriesBloc>()
          .add(FetchSeasonDetailTvSeries(
            id: widget.id,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: BlocBuilder<SeasonDetailTvSeriesBloc, SeasonDetailTvSeriesState>(
          builder: (_, state) {
            if (state is SeasonDetailTvSeriesData) {
      ...
      body: BlocBuilder<SeasonDetailTvSeriesBloc, SeasonDetailTvSeriesState>(
        builder: (_, state) {
          ...
          } else if (state is SeasonDetailTvSeriesData) {
          ...
          } else if (state is SeasonDetailTvSeriesError) {
            return Center(

...
import 'package:ditonton_app/domain/usecases/movie.dart/get_top_rated_movies.dart' as i4;
...
class MockGetTopRatedMovies extends i1.Mock implements i4.GetTopRatedMovies {
  ...
  @override
  i5.Future<i3.Either<i6.Failure, List<i7.Movie>>> execute() => (super
          .noSuchMethod(Invocation.method(#execute, []),
              returnValue:
                  Future<i3.Either<i6.Failure, List<i7.Movie>>>.value(
